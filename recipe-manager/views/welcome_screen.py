...
class WelcomeScreen:
    def __init__(self, root, controller):
        ...
        tk.Label(self.frame, text="Welcome to Recipes.", font=("Helvetica", 36, "bold"), 
        ...
        tk.Button(self.frame, text="Start Cooking", font=("Helvetica", 16), bg="#f1c40f", fg="white",
                  relief="flat", command=self.controller.show_categories, padx=30, pady=15).pack(pady=30)
